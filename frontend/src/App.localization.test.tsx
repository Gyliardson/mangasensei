...
describe("App UI localization", () => {
  ...
  it("switches UI and study languages while normalizing a stale dictionary preference", async () => {
  ...
  it("falls back to English for invalid persisted UI and dictionary preferences", () => {
