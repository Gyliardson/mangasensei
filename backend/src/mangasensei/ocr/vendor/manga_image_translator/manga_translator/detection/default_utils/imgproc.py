...
def loadImage(img_file):
    # MangaSensei modification 2026-08-09: Pillow replaces the otherwise
    # unused scikit-image dependency for this file-loading helper.
    with Image.open(img_file) as source:
