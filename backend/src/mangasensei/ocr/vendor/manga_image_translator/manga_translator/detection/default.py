...
from ..utils.generic import Quadrilateral, det_rearrange_forward
...
class DefaultDetector(OfflineDetector):
    ...
    async def _load(self, device: str):
        ...
        # MangaSensei modification 2026-08-07: checkpoints are fixed by manifest
        # and loaded through PyTorch's restricted weights-only unpickler.
        sd = torch.load(self._get_file_path('detect-20241225.ckpt'), map_location='cpu', weights_only=True)
